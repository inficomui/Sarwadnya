...
import { useCreateBlogMutation } from "@/redux/apies/blogApi";
import { Button } from "@/components/ui/button";
import { useRouter } from "next/navigation";
import { ArrowLeft, Image as ImageIcon, Video, Eye, Edit2 } from "lucide-react";
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6 pb-20">
            ...
            <div className="flex items-center gap-4 bg-card p-6 rounded-3xl border border-border shadow-sm">
                ...
                <div>
                    <h1 className="text-2xl font-bold tracking-tight text-foreground">Create New Post</h1>
                    <p className="text-sm text-muted-foreground">Draft your article and share your insights with the world.</p>
                </div>
            </div>
                        ...
                        {showPreview ? (
                            ...
                            <div className="relative group">
                                <textarea
                                    ...
                                    placeholder="Write your content here... (HTML is supported for advanced formatting)"
                                    value={content}
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-card rounded-3xl border border-border shadow-sm p-6 space-y-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <Button type="submit" disabled={isLoading} className="w-full h-12 rounded-xl text-base font-semibold shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all bg-primary hover:bg-primary/90 text-primary-foreground">
