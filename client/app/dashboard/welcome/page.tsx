        ...
        <>
            ...
            <div className="space-y-6 max-w-5xl mx-auto pb-12">
                ...
                <div className="flex justify-center bg-slate-100 dark:bg-slate-900 py-8 overflow-hidden rounded-xl">
                    ...
                    >
                        {/* Decorative Border */}
                        <div className="absolute inset-0 border-12 border-double border-orange-100 m-3 pointer-events-none z-20"></div>
                        ...
                        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0 overflow-hidden">
                            <div className="w-[500px] h-[500px] rounded-full bg-orange-500/3 blur-3xl transform -translate-y-12"></div>
                            <h1 className="absolute text-[80px] md:text-[100px] font-bold text-slate-900/2 transform -rotate-45 select-none font-serif text-center leading-tight">SHREE SARWADNYA</h1>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="text-center pt-2 border-t border-slate-100 mb-8 pb-4">
                                    ...
                                    <p className="text-[10px] text-slate-300">
                                        Shree Sarwadnya All in one solutions &copy; {mounted ? new Date().getFullYear() : "..."}. All rights reserved.
                                    </p>
                                </div>
                            </div>
                        </div>
