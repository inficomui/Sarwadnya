...
import { Mail, Lock, Eye, EyeOff, ArrowRight, ShieldCheck, Loader2, ArrowLeft } from "lucide-react";
import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import * as z from "zod";
import { useRouter } from "next/navigation";
import toast, { Toaster } from "react-hot-toast";
import { useAdminLoginMutation } from "@/redux/apies/adminApi";
    ...
    const onSubmit = async (data: AdminLoginFormData) => {
        ...
        try {
            ...
            if (result?.user?.role !== 'admin') {
                ...
                // Clear local storage if role is invalid
            ...
            // Note: LocalStorage is already set in the API transformResponse
                        ...
                        <div className="lg:w-1/2 relative bg-gray-900 text-white p-12 flex flex-col justify-between overflow-hidden">
                            ...
                            >
                                ...
                                <h1 className="text-4xl font-bold mb-4 leading-tight">
                                    Admin Portal <br /> <span className="text-primary">Shree Sarwadnya All in One Solutions.</span>
                                </h1>
                                <p className="text-gray-300 text-lg">
                                    Manage users, investments, and track <br /> platform performance securely.
                                </p>
                            </motion.div>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400">Authorized person only</p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div className="lg:w-1/2 p-8 md:p-12 relative flex flex-col justify-center bg-card">
                            ...
                            >
                                <div className="mb-8">
                                    ...
                                    <p className="text-muted-foreground">Please sign in to the administration area.</p>
                                </div>
                                ...
                                <div className="mt-8 pt-6 border-t border-border text-center">
                                    <p className="text-xs text-muted-foreground">
                                        Secure Admin Area. IP Address Logged.
                                    </p>
                                </div>
                            </motion.div>
                        </div>
