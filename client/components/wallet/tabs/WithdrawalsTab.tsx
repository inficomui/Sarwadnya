...
import { TrendingDown, Clock, FileText, CheckCircle2, XCircle, Calendar } from 'lucide-react';
...
const WithdrawalsTab = ({ isLoading, withdrawalsData }: WithdrawalsTabProps) => {
...
export default React.memo(WithdrawalsTab);
